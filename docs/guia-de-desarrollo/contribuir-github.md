...
- Título de PR claro.
- Descripción con contexto, pasos para probar y screenshots si aplica.

## Status checks y CI

- Todos los checks (tests, lint, CI/CD) deben pasar antes de mergear.
- Avisar en Discord si algo falla y no mergear hasta solucionarlo.
