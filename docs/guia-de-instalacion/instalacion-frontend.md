...
## Instalación
Todas las dependencias están en el package.json, ejecutando `npm install` se debería de instalar todo lo necesario para ejecutar el frontend.

Luego para ejecutar en local `npm run dev`
